          ...
          <div className="row">
            <div className="col-lg-4 col-sm-6 col-md-6">
              <div className="agency-services-box">
                <img
                  src={require("../../static/images/agency-image/agency-services-img1.jpg")}
                  alt="image"
                />
            ...
            <div className="col-lg-4 col-sm-6 col-md-6">
              <div className="agency-services-box">
                <img
                  src={require("../../static/images/agency-image/agency-services-img2.jpg")}
                  alt="image"
                />
            ...
            <div className="col-lg-4 col-sm-6 col-md-6">
              <div className="agency-services-box">
                <img
                  src={require("../../static/images/agency-image/agency-services-img3.jpg")}
                  alt="image"
                />
